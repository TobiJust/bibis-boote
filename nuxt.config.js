...
export default {
  ...
  modules: [
    ...
    [
      "nuxt-gmaps",
      {
        key: "AIzaSyCjfk5cOhTIHqENMTtgLdNOfkPE7hYEpjk",
    ...
    vueI18n: {
      ...
      messages: {
        de: {
          ...
          admin: "Admin",
          banner_text:
            "Wir haben geöffnet: Jetzt reservieren und Wunschtermin sichern!",
          boats: "Boote",
          contact: "Kontakt",
          day: "Tag",
        ...
        en: {
          ...
          admin: "Admin",
          banner_text:
            "We're open: Reserve now and secure your preferred date!",
          boats: "Boats",
          contact: "Contact",
          day: "day",
